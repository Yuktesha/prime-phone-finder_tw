...
<head>
    ...
    <style>
        ...
        @media (max-width: 1600px) {
            .plate-result-item, .full-plate-result-item {
                width: calc(25% - 16px);
            }
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function displayResults(data) {
                ...
                data.full.closest_primes.forEach(item => {
                    ...
                    html += `
                        <div class="full-plate-result-item">
                            <table class="full-plate-table">
                                <tr class="full-plate-top-row">
                                    <td>${formattedPlate}</td>
                                </tr>
                                <tr class="full-plate-bottom-row">
                                    <td>
