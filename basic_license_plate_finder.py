        ...
        <form id="search-form" action="/search" method="post">
            <div class="input-container">
                <div class="plate-input-group">
                    <input type="text" id="part1" name="part1" placeholder="前半部" maxlength="5" required>
                    <span class="separator">-</span>
                    <input type="text" id="part2" name="part2" placeholder="後半部" maxlength="5" required>
                </div>
                
                <div class="count-group">
                    <label for="count">顯示數量:</label>
                    <input type="number" id="count" name="count" min="1" max="256" value="10">
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            searchForm.addEventListener('submit', function(e) {
                ...
                const part1 = formData.get('part1').trim().toUpperCase();
                const part2 = formData.get('part2').trim().toUpperCase();
